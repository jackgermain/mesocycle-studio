      ...
      <div className="screen-scroll">
        <div>
          ...
          <div className="mu" style={{ marginTop: 7 }}>
            {mode === "off" && "No food tracking — their Nutrition tab stays weigh-ins only."}
            {mode === "macros" && "Full calorie and gram targets with meal logging — for clients who want the precision."}
            {mode === "portions" && "Hand and plate portions, no numbers to log — for clients who do better with a simpler system."}
          </div>
        </div>
        ...
        <div>
          ...
          />
          <div className="mu" style={{ marginTop: 7 }}>Required, not optional — the client can't close the day without it. Feeds the weight chart on their Progress tab.</div>
        </div>
          ...
          <div>
            ...
            <div className="cell" style={{ padding: 11, marginBottom: 10 }}>
              ...
              <div className="mu" style={{ marginBottom: 9, lineHeight: 1.5 }}>
                Protein is set from lean body mass — around 1 g per lb LBM — not total bodyweight, so a higher body-fat client isn't over-prescribed. Fat and carbs fill in around it. Optional — you can still hand-edit anything below.
              </div>
