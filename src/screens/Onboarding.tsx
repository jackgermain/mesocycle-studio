...
export default function Onboarding() {
  ...
  // Wrapped, not rendered inline: this is the one screen between claiming the invite and using the
  // app, so it is the only place a home-screen prompt is unmissable. It renders this screen untouched
  // on anything that is already installed or cannot install at all.
  return (
    <InstallStep>
